...
public class usafootball_input {
    ...
    public static class MyAdapter extends RecyclerView.Adapter < MyAdapter.ViewHolder > {
        ...
        public MyAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View v = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.item_gameover_usafootball, parent, false);
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position, List payloads) {
            ...
            if (score[0] != null) {
                ...
                if (score[8].isEmpty() || score[8].matches("-")) {
                    holder.homelate.setText("-");
                } else {
                    holder.homelate.setText(score[8]);
                }
                if (score[9].isEmpty() || score[9].matches("-")) {
                    holder.awaylate.setText("-");
                } else {
                    holder.awaylate.setText(score[9]);
                }
            }
            // /
